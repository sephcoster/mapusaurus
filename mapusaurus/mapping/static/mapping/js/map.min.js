...
function toggleSuper(status) {
    ...
    $("#download-data").attr("href", url)) : ($("#lender-affiliate-list").addClass("hidden"), 
...
function drawCircle(geo, layerType) {
    ...
    circle.geoid = geo.geoid, circle.volume = geo.volume, circle.on("mouseover mousemove", function(e) {
        ...
        new L.Rrose({
            ...
            closeButton: !1,
            autoPan: !1
        }).setContent('<div style="border-bottom: 1px solid gray"><b>Tract # ' + circle.geoid + "</b><br/>" + data.volume + " <b>records<br />" + data.num_households + " <b>households</b></div><br/><b>Hispanic</b>: (" + hisp + '%)<br/><span class="spark-bullet" data-min="[' + [ hisp, hisp, 100 ] + ']"></span><br/><b>Black</b>: (' + black + '%)<br/><span class="spark-bullet" data-min="[' + [ black, black, 100 ] + ']"></span><br/><b>Asian</b>: (' + asian + '%)<br/><span class="spark-bullet" data-min="[' + [ asian, asian, 100 ] + ']"></span><br/><b>White</b>: (' + white + '%)<br/><span class="spark-bullet" data-min="[' + [ white, white, 100 ] + ']"></span>').setLatLng(e.latlng).openOn(map), 
        $(".spark-bullet").each(function() {
            var sparkData = $(this).data("min");
            console.log("SparkData"), $(this).sparkline(sparkData, {
                type: "bullet",
                height: "10px",
                targetColor: "#000",
